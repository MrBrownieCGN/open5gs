...
asn_per_constraints_t asn_PER_type_S1AP_AerialUEsubscriptionInformation_constr_1 CC_NOTUSED = {
...
static int asn_validate_S1AP_AerialUEsubscriptionInformation_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_AerialUEsubscriptionInformation value = *(e_S1AP_AerialUEsubscriptionInformation*)sptr;
    switch(value) {
    case S1AP_AerialUEsubscriptionInformation_allowed:
    case S1AP_AerialUEsubscriptionInformation_not_allowed:
        return 0;
    }
    return -1;
}
...
const asn_INTEGER_specifics_t asn_SPC_S1AP_AerialUEsubscriptionInformation_specs_1 = {
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_S1AP_AerialUEsubscriptionInformation_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		asn_validate_S1AP_AerialUEsubscriptionInformation_1
	},
