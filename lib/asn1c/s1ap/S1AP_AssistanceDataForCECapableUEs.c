...
asn_TYPE_member_t asn_MBR_S1AP_AssistanceDataForCECapableUEs_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_AssistanceDataForCECapableUEs, cellIdentifierAndCELevelForCECapableUEs),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_AssistanceDataForCECapableUEs, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P23,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
