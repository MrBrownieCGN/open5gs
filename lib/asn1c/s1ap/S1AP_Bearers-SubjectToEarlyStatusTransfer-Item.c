...
asn_TYPE_member_t asn_MBR_S1AP_Bearers_SubjectToEarlyStatusTransfer_Item_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_Bearers_SubjectToEarlyStatusTransfer_Item, dLCOUNT_PDCP_SNlength),
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_Bearers_SubjectToEarlyStatusTransfer_Item_specs_1 = {
