...
struct S1AP_ProtocolExtensionContainer_8194P26;
...
typedef struct S1AP_Bearers_SubjectToStatusTransfer_Item {
	...
	struct S1AP_COUNTvalue	*uL_COUNTvalue;
	struct S1AP_COUNTvalue	*dL_COUNTvalue;
...
extern asn_TYPE_member_t asn_MBR_S1AP_Bearers_SubjectToStatusTransfer_Item_1[5];
