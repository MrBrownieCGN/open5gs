...
extern asn_TYPE_descriptor_t asn_DEF_S1AP_bt_rssi __attribute__((weak, alias("asn_DEF_S1AP_bt_rssi_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_S1AP_bt_rssi_4;
static asn_TYPE_descriptor_t asn_DEF_S1AP_bt_rssi;
__attribute__((constructor)) static void asn_DEF_S1AP_bt_rssi_4_alias_init(void) {
	asn_DEF_S1AP_bt_rssi = asn_DEF_S1AP_bt_rssi_4;
}
#endif
...
static int asn_validate_S1AP_bt_rssi_4(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_BluetoothMeasurementConfiguration__bt_rssi value = *(e_S1AP_BluetoothMeasurementConfiguration__bt_rssi*)sptr;
    switch(value) {
    case S1AP_BluetoothMeasurementConfiguration__bt_rssi_true:
        return 0;
    }
    return -1;
}
