...
asn_per_constraints_t asn_PER_type_S1AP_CNDomain_constr_1 CC_NOTUSED = {
...
static int asn_validate_S1AP_CNDomain_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_CNDomain value = *(e_S1AP_CNDomain*)sptr;
    switch(value) {
    case S1AP_CNDomain_ps:
    case S1AP_CNDomain_cs:
        return 0;
    }
    return -1;
}
...
const asn_INTEGER_specifics_t asn_SPC_S1AP_CNDomain_specs_1 = {
