...
asn_per_constraints_t asn_PER_type_S1AP_CSFallbackIndicator_constr_1 CC_NOTUSED = {
...
static int asn_validate_S1AP_CSFallbackIndicator_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_CSFallbackIndicator value = *(e_S1AP_CSFallbackIndicator*)sptr;
    switch(value) {
    case S1AP_CSFallbackIndicator_cs_fallback_required:
    case S1AP_CSFallbackIndicator_cs_fallback_high_priority:
        return 0;
    }
    return -1;
}
...
const asn_INTEGER_specifics_t asn_SPC_S1AP_CSFallbackIndicator_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_S1AP_CSFallbackIndicator = {
		...
		/sizeof(asn_DEF_S1AP_CSFallbackIndicator_tags_1[0]), /* 1 */
	{
		...
		asn_validate_S1AP_CSFallbackIndicator_1
	},
