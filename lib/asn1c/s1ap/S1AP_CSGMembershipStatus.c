...
static int asn_validate_S1AP_CSGMembershipStatus_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_CSGMembershipStatus value = *(e_S1AP_CSGMembershipStatus*)sptr;
    switch(value) {
    case S1AP_CSGMembershipStatus_member:
    case S1AP_CSGMembershipStatus_not_member:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_S1AP_CSGMembershipStatus = {
		...
		/sizeof(asn_DEF_S1AP_CSGMembershipStatus_tags_1[0]), /* 1 */
	{
		...
		asn_validate_S1AP_CSGMembershipStatus_1
	},
