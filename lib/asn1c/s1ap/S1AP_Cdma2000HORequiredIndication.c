...
static int asn_validate_S1AP_Cdma2000HORequiredIndication_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_Cdma2000HORequiredIndication value = *(e_S1AP_Cdma2000HORequiredIndication*)sptr;
    switch(value) {
    case S1AP_Cdma2000HORequiredIndication_true:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_S1AP_Cdma2000HORequiredIndication = {
		...
		/sizeof(asn_DEF_S1AP_Cdma2000HORequiredIndication_tags_1[0]), /* 1 */
	{
		...
		asn_validate_S1AP_Cdma2000HORequiredIndication_1
	},
