...
asn_TYPE_member_t asn_MBR_S1AP_CompletedCellinEAI_Item_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_CompletedCellinEAI_Item, eCGI),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_CompletedCellinEAI_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P55,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_S1AP_CompletedCellinEAI_Item_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_S1AP_CompletedCellinEAI_Item_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_S1AP_CompletedCellinEAI_Item_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eCGI */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* iE-Extensions */
};
asn_SEQUENCE_specifics_t asn_SPC_S1AP_CompletedCellinEAI_Item_specs_1 = {
