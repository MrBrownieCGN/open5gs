...
typedef S1AP_E_RAB_IE_ContainerList_1280P9_t	 S1AP_E_RABFailedToResumeListResumeReq_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_S1AP_E_RABFailedToResumeListResumeReq_constr_1;
