...
struct S1AP_AllocationAndRetentionPriority;
struct S1AP_GBR_QosInformation;
struct S1AP_ProtocolExtensionContainer_8194P68;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_E-RABLevelQoSParameters */
typedef struct S1AP_E_RABLevelQoSParameters {
	S1AP_QCI_t	 qCI;
	struct S1AP_AllocationAndRetentionPriority	*allocationRetentionPriority;
