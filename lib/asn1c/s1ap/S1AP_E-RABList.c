...
asn_per_constraints_t asn_PER_type_S1AP_E_RABList_constr_1 CC_NOTUSED = {
...
static const ber_tlv_tag_t asn_DEF_S1AP_E_RABList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_S1AP_E_RABList_specs_1 = {
