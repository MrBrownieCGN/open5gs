...
/*
 * This type is implemented using S1AP_E_RAB_IE_ContainerList_1280P8,
 * so here we adjust the DEF accordingly.
 */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_S1AP_E_RABNotToBeModifiedListBearerModInd_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_S1AP_E_RABNotToBeModifiedListBearerModInd = {
		...
		/sizeof(asn_DEF_S1AP_E_RABNotToBeModifiedListBearerModInd_tags_1[0]), /* 1 */
	{
		...
		S1AP_E_RABNotToBeModifiedListBearerModInd_constraint
	},
