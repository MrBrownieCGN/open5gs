...
asn_per_constraints_t asn_PER_type_S1AP_E_RABReleaseListBearerRelComp_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_S1AP_E_RABReleaseListBearerRelComp_1[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_S1AP_ProtocolIE_SingleContainer_8146P4,
		0,
		{
...
asn_SET_OF_specifics_t asn_SPC_S1AP_E_RABReleaseListBearerRelComp_specs_1 = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_S1AP_E_RABReleaseListBearerRelComp_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
