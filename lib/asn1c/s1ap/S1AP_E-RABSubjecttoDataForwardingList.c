...
int
S1AP_E_RABSubjecttoDataForwardingList_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
/*
 * This type is implemented using S1AP_E_RAB_IE_ContainerList_1280P0,
