...
asn_TYPE_member_t asn_MBR_S1AP_E_RABToBeModifiedItemBearerModInd_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_E_RABToBeModifiedItemBearerModInd, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P15,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_E_RABToBeModifiedItemBearerModInd_specs_1 = {
