...
asn_TYPE_member_t asn_MBR_S1AP_E_RABToBeSetupItemBearerSUReq_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_E_RABToBeSetupItemBearerSUReq, e_RABlevelQoSParameters),
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_E_RABToBeSetupItemBearerSUReq_specs_1 = {
