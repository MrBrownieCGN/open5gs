...
asn_per_constraints_t asn_PER_type_S1AP_E_RABToBeSetupListCtxtSUReq_constr_1 CC_NOTUSED = {
...
asn_SET_OF_specifics_t asn_SPC_S1AP_E_RABToBeSetupListCtxtSUReq_specs_1 = {
