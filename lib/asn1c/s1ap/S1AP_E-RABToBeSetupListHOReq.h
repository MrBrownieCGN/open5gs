...
typedef S1AP_E_RAB_IE_ContainerList_1280P1_t	 S1AP_E_RABToBeSetupListHOReq_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_S1AP_E_RABToBeSetupListHOReq_constr_1;
