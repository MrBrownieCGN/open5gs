...
typedef S1AP_E_RAB_IE_ContainerList_1280P4_t	 S1AP_E_RABToBeSwitchedDLList_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_S1AP_E_RABToBeSwitchedDLList_constr_1;
