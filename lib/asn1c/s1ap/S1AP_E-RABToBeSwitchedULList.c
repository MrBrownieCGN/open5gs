...
int
S1AP_E_RABToBeSwitchedULList_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
/*
 * This type is implemented using S1AP_E_RAB_IE_ContainerList_1280P5,
 * so here we adjust the DEF accordingly.
 */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_S1AP_E_RABToBeSwitchedULList_constr_1 CC_NOTUSED = {
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_S1AP_E_RABToBeSwitchedULList_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
