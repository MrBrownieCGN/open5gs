...
asn_TYPE_member_t asn_MBR_S1AP_EN_DCSONConfigurationTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_EN_DCSONConfigurationTransfer, transfertype),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_EN_DCSONConfigurationTransfer, sONInformation),
