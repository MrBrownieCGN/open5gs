...
asn_TYPE_member_t asn_MBR_S1AP_ENB_EarlyStatusTransfer_TransparentContainer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_ENB_EarlyStatusTransfer_TransparentContainer, bearers_SubjectToEarlyStatusTransferList),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_ENB_EarlyStatusTransfer_TransparentContainer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P56,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_ENB_EarlyStatusTransfer_TransparentContainer_specs_1 = {
