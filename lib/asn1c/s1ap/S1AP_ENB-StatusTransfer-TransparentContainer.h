...
struct S1AP_Bearers_SubjectToStatusTransferList;
struct S1AP_ProtocolExtensionContainer_8194P60;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_ENB-StatusTransfer-TransparentContainer */
typedef struct S1AP_ENB_StatusTransfer_TransparentContainer {
	struct S1AP_Bearers_SubjectToStatusTransferList	*bearers_SubjectToStatusTransferList;
...
extern asn_SEQUENCE_specifics_t asn_SPC_S1AP_ENB_StatusTransfer_TransparentContainer_specs_1;
extern asn_TYPE_member_t asn_MBR_S1AP_ENB_StatusTransfer_TransparentContainer_1[2];
