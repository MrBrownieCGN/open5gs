...
extern asn_TYPE_descriptor_t asn_DEF_S1AP_encoding __attribute__((weak, alias("asn_DEF_S1AP_encoding_5")));
#else
static asn_TYPE_descriptor_t asn_DEF_S1AP_encoding_5;
static asn_TYPE_descriptor_t asn_DEF_S1AP_encoding;
__attribute__((constructor)) static void asn_DEF_S1AP_encoding_5_alias_init(void) {
	asn_DEF_S1AP_encoding = asn_DEF_S1AP_encoding_5;
}
#endif
...
static asn_TYPE_member_t asn_MBR_S1AP_EXTERNAL__encoding_5[] = {
...
asn_TYPE_descriptor_t asn_DEF_S1AP_encoding_5 = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_S1AP_encoding_constr_5,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	asn_MBR_S1AP_EXTERNAL__encoding_5,
	3,	/* Elements count */
