...
struct S1AP_CancelledCellinEAI;
struct S1AP_ProtocolExtensionContainer_8194P54;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_EmergencyAreaID-Cancelled-Item */
typedef struct S1AP_EmergencyAreaID_Cancelled_Item {
	S1AP_EmergencyAreaID_t	 emergencyAreaID;
	struct S1AP_CancelledCellinEAI	*cancelledCellinEAI;
...
extern asn_TYPE_member_t asn_MBR_S1AP_EmergencyAreaID_Cancelled_Item_1[3];
