...
asn_per_constraints_t asn_PER_type_S1AP_EventType_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  2 }	/* (0..2,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const asn_INTEGER_enum_map_t asn_MAP_S1AP_EventType_value2enum_1[] = {
	{ 0,	6,	"direct" },
	{ 1,	20,	"change-of-serve-cell" },
	{ 2,	25,	"stop-change-of-serve-cell" }
	/* This list is extensible */
};
static int asn_validate_S1AP_EventType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_EventType value = *(e_S1AP_EventType*)sptr;
    switch(value) {
    case S1AP_EventType_direct:
    case S1AP_EventType_change_of_serve_cell:
    case S1AP_EventType_stop_change_of_serve_cell:
        return 0;
    }
    return -1;
}
static const unsigned int asn_MAP_S1AP_EventType_enum2value_1[] = {
	1,	/* change-of-serve-cell(1) */
	0,	/* direct(0) */
	2	/* stop-change-of-serve-cell(2) */
	/* This list is extensible */
};
const asn_INTEGER_specifics_t asn_SPC_S1AP_EventType_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_S1AP_EventType_tags_1[] = {
