...
/* S1AP_GNB-ID */
typedef BIT_STRING_t	 S1AP_GNB_ID_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_S1AP_GNB_ID_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_S1AP_GNB_ID;
