...
int
S1AP_GTP_TEID_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
asn_per_constraints_t asn_PER_type_S1AP_GTP_TEID_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  4,  4 }	/* (SIZE(4..4)) */,
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static const ber_tlv_tag_t asn_DEF_S1AP_GTP_TEID_tags_1[] = {
