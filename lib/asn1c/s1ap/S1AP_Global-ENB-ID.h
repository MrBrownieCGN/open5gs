...
struct S1AP_ENB_ID;
struct S1AP_ProtocolExtensionContainer_8194P58;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_Global-ENB-ID */
typedef struct S1AP_Global_ENB_ID {
	S1AP_PLMNidentity_t	 pLMNidentity;
	struct S1AP_ENB_ID	*eNB_ID;
...
extern asn_SEQUENCE_specifics_t asn_SPC_S1AP_Global_ENB_ID_specs_1;
extern asn_TYPE_member_t asn_MBR_S1AP_Global_ENB_ID_1[3];
