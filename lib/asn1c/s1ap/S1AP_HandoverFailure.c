...
asn_TYPE_member_t asn_MBR_S1AP_HandoverFailure_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_HandoverFailure, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolIE_Container_8143P5,
		0,
		{
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_HandoverFailure_specs_1 = {
