...
asn_per_constraints_t asn_PER_type_S1AP_HandoverType_constr_1 CC_NOTUSED = {
...
static int asn_validate_S1AP_HandoverType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_HandoverType value = *(e_S1AP_HandoverType*)sptr;
    switch(value) {
...
asn_TYPE_descriptor_t asn_DEF_S1AP_HandoverType = {
		...
		/sizeof(asn_DEF_S1AP_HandoverType_tags_1[0]), /* 1 */
	{
		...
		asn_validate_S1AP_HandoverType_1
	},
