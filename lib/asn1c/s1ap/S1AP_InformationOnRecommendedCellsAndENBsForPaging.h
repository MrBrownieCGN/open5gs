...
struct S1AP_RecommendedCellsForPaging;
struct S1AP_RecommendedENBsForPaging;
struct S1AP_ProtocolExtensionContainer_8194P82;
...
typedef struct S1AP_InformationOnRecommendedCellsAndENBsForPaging {
	struct S1AP_RecommendedCellsForPaging	*recommendedCellsForPaging;
	struct S1AP_RecommendedENBsForPaging	*recommendENBsForPaging;
