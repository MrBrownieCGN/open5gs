...
asn_per_constraints_t asn_PER_type_S1AP_Inter_SystemInformationTransferType_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  0,  0,  0,  0 }	/* (0..0,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
asn_TYPE_member_t asn_MBR_S1AP_Inter_SystemInformationTransferType_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_S1AP_Inter_SystemInformationTransferType_specs_1 = {
