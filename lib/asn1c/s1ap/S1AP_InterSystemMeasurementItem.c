...
extern asn_TYPE_descriptor_t asn_DEF_S1AP_subcarrierSpacingSSB __attribute__((weak, alias("asn_DEF_S1AP_subcarrierSpacingSSB_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_S1AP_subcarrierSpacingSSB_4;
static asn_TYPE_descriptor_t asn_DEF_S1AP_subcarrierSpacingSSB;
__attribute__((constructor)) static void asn_DEF_S1AP_subcarrierSpacingSSB_4_alias_init(void) {
	asn_DEF_S1AP_subcarrierSpacingSSB = asn_DEF_S1AP_subcarrierSpacingSSB_4;
}
#endif
...
static int asn_validate_S1AP_subcarrierSpacingSSB_4(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB value = *(e_S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB*)sptr;
    switch(value) {
    case S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz15:
    case S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz30:
    case S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz60:
    case S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz120:
    case S1AP_InterSystemMeasurementItem__subcarrierSpacingSSB_kHz240:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_S1AP_subcarrierSpacingSSB_4 = {
		...
		/sizeof(asn_DEF_S1AP_subcarrierSpacingSSB_tags_4[0]), /* 2 */
	{
		...
		asn_validate_S1AP_subcarrierSpacingSSB_4
	},
