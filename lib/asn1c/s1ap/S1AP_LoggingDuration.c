...
static int asn_validate_S1AP_LoggingDuration_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_LoggingDuration value = *(e_S1AP_LoggingDuration*)sptr;
    switch(value) {
    case S1AP_LoggingDuration_m10:
    case S1AP_LoggingDuration_m20:
    case S1AP_LoggingDuration_m40:
    case S1AP_LoggingDuration_m60:
    case S1AP_LoggingDuration_m90:
    case S1AP_LoggingDuration_m120:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_S1AP_LoggingDuration = {
		...
		/sizeof(asn_DEF_S1AP_LoggingDuration_tags_1[0]), /* 1 */
	{
		...
		asn_validate_S1AP_LoggingDuration_1
	},
