...
static int asn_validate_S1AP_LoggingInterval_1(const asn_TYPE_descriptor_t *td,
    ...
    switch(value) {
    case S1AP_LoggingInterval_ms128:
    case S1AP_LoggingInterval_ms256:
    case S1AP_LoggingInterval_ms512:
    case S1AP_LoggingInterval_ms1024:
    case S1AP_LoggingInterval_ms2048:
    case S1AP_LoggingInterval_ms3072:
    case S1AP_LoggingInterval_ms4096:
    case S1AP_LoggingInterval_ms6144:
        return 0;
    }
    return -1;
}
