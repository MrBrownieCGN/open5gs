...
static int asn_validate_S1AP_M4period_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_M4period value = *(e_S1AP_M4period*)sptr;
    switch(value) {
    case S1AP_M4period_ms1024:
    case S1AP_M4period_ms2048:
    case S1AP_M4period_ms5120:
    case S1AP_M4period_ms10240:
    case S1AP_M4period_min1:
        return 0;
    }
    return -1;
}
