...
static int asn_validate_S1AP_MDT_Activation_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_MDT_Activation value = *(e_S1AP_MDT_Activation*)sptr;
    switch(value) {
    case S1AP_MDT_Activation_immediate_MDT_only:
    case S1AP_MDT_Activation_immediate_MDT_and_Trace:
    case S1AP_MDT_Activation_logged_MDT_only:
    case S1AP_MDT_Activation_logged_MBSFN_MDT:
        return 0;
    }
    return -1;
}
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_S1AP_MDT_Activation_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		asn_validate_S1AP_MDT_Activation_1
	},
