...
/* S1AP_MME-Group-ID */
typedef OCTET_STRING_t	 S1AP_MME_Group_ID_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_S1AP_MME_Group_ID_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_S1AP_MME_Group_ID;
