...
extern asn_TYPE_descriptor_t asn_DEF_S1AP_muting_pattern_period __attribute__((weak, alias("asn_DEF_S1AP_muting_pattern_period_2")));
#else
static asn_TYPE_descriptor_t asn_DEF_S1AP_muting_pattern_period_2;
static asn_TYPE_descriptor_t asn_DEF_S1AP_muting_pattern_period;
__attribute__((constructor)) static void asn_DEF_S1AP_muting_pattern_period_2_alias_init(void) {
	asn_DEF_S1AP_muting_pattern_period = asn_DEF_S1AP_muting_pattern_period_2;
}
#endif
...
static int asn_validate_S1AP_muting_pattern_period_2(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_MutingPatternInformation__muting_pattern_period value = *(e_S1AP_MutingPatternInformation__muting_pattern_period*)sptr;
    switch(value) {
    case S1AP_MutingPatternInformation__muting_pattern_period_ms0:
    case S1AP_MutingPatternInformation__muting_pattern_period_ms1280:
    case S1AP_MutingPatternInformation__muting_pattern_period_ms2560:
    case S1AP_MutingPatternInformation__muting_pattern_period_ms5120:
    case S1AP_MutingPatternInformation__muting_pattern_period_ms10240:
        return 0;
    }
    return -1;
}
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_S1AP_muting_pattern_period_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		asn_validate_S1AP_muting_pattern_period_2
	},
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_S1AP_muting_pattern_offset_constr_9,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
