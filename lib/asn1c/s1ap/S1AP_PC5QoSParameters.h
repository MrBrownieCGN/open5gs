...
struct S1AP_PC5QoSFlowList;
struct S1AP_ProtocolExtensionContainer_8194P108;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_PC5QoSParameters */
typedef struct S1AP_PC5QoSParameters {
	struct S1AP_PC5QoSFlowList	*pc5QoSFlowList;
...
extern asn_TYPE_member_t asn_MBR_S1AP_PC5QoSParameters_1[3];
