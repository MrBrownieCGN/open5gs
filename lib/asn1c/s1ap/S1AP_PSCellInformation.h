...
struct S1AP_NR_CGI;
struct S1AP_ProtocolExtensionContainer_8194P114;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_PSCellInformation */
typedef struct S1AP_PSCellInformation {
	struct S1AP_NR_CGI	*nCGI;
...
extern asn_SEQUENCE_specifics_t asn_SPC_S1AP_PSCellInformation_specs_1;
extern asn_TYPE_member_t asn_MBR_S1AP_PSCellInformation_1[2];
