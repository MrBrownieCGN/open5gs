...
static int asn_validate_S1AP_Presence_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_Presence value = *(e_S1AP_Presence*)sptr;
    switch(value) {
    case S1AP_Presence_optional:
    case S1AP_Presence_conditional:
    case S1AP_Presence_mandatory:
        return 0;
    }
    return -1;
}
