...
#define S1AP_ProcedureCode_id_UERadioCapabilityIDMapping	((S1AP_ProcedureCode_t)63)
#define S1AP_ProcedureCode_id_HandoverSuccess	((S1AP_ProcedureCode_t)64)
#define S1AP_ProcedureCode_id_eNBEarlyStatusTransfer	((S1AP_ProcedureCode_t)65)
#define S1AP_ProcedureCode_id_MMEEarlyStatusTransfer	((S1AP_ProcedureCode_t)66)
