...
#define S1AP_ProtocolIE_ID_id_IAB_Authorized	((S1AP_ProtocolIE_ID_t)301)
#define S1AP_ProtocolIE_ID_id_IAB_Node_Indication	((S1AP_ProtocolIE_ID_t)302)
#define S1AP_ProtocolIE_ID_id_IAB_Supported	((S1AP_ProtocolIE_ID_t)303)
#define S1AP_ProtocolIE_ID_id_DataSize	((S1AP_ProtocolIE_ID_t)304)
#define S1AP_ProtocolIE_ID_id_Ethernet_Type	((S1AP_ProtocolIE_ID_t)305)
#define S1AP_ProtocolIE_ID_id_NRV2XServicesAuthorized	((S1AP_ProtocolIE_ID_t)306)
#define S1AP_ProtocolIE_ID_id_NRUESidelinkAggregateMaximumBitrate	((S1AP_ProtocolIE_ID_t)307)
#define S1AP_ProtocolIE_ID_id_PC5QoSParameters	((S1AP_ProtocolIE_ID_t)308)
#define S1AP_ProtocolIE_ID_id_IntersystemSONConfigurationTransferMCT	((S1AP_ProtocolIE_ID_t)309)
#define S1AP_ProtocolIE_ID_id_IntersystemSONConfigurationTransferECT	((S1AP_ProtocolIE_ID_t)310)
#define S1AP_ProtocolIE_ID_id_IntersystemMeasurementConfiguration	((S1AP_ProtocolIE_ID_t)311)
#define S1AP_ProtocolIE_ID_id_SourceNodeID	((S1AP_ProtocolIE_ID_t)312)
#define S1AP_ProtocolIE_ID_id_NB_IoT_RLF_Report_Container	((S1AP_ProtocolIE_ID_t)313)
#define S1AP_ProtocolIE_ID_id_UERadioCapabilityID	((S1AP_ProtocolIE_ID_t)314)
#define S1AP_ProtocolIE_ID_id_UERadioCapability_NR_Format	((S1AP_ProtocolIE_ID_t)315)
#define S1AP_ProtocolIE_ID_id_MDTConfigurationNR	((S1AP_ProtocolIE_ID_t)316)
#define S1AP_ProtocolIE_ID_id_DAPSRequestInfo	((S1AP_ProtocolIE_ID_t)317)
#define S1AP_ProtocolIE_ID_id_DAPSResponseInfoList	((S1AP_ProtocolIE_ID_t)318)
#define S1AP_ProtocolIE_ID_id_DAPSResponseInfoItem	((S1AP_ProtocolIE_ID_t)319)
#define S1AP_ProtocolIE_ID_id_NotifySourceeNB	((S1AP_ProtocolIE_ID_t)320)
#define S1AP_ProtocolIE_ID_id_eNB_EarlyStatusTransfer_TransparentContainer	((S1AP_ProtocolIE_ID_t)321)
#define S1AP_ProtocolIE_ID_id_Bearers_SubjectToEarlyStatusTransfer_Item	((S1AP_ProtocolIE_ID_t)322)
#define S1AP_ProtocolIE_ID_id_WUS_Assistance_Information	((S1AP_ProtocolIE_ID_t)323)
#define S1AP_ProtocolIE_ID_id_NB_IoT_PagingDRX	((S1AP_ProtocolIE_ID_t)324)
#define S1AP_ProtocolIE_ID_id_TraceCollectionEntityURI	((S1AP_ProtocolIE_ID_t)325)
#define S1AP_ProtocolIE_ID_id_EmergencyIndicator	((S1AP_ProtocolIE_ID_t)326)
#define S1AP_ProtocolIE_ID_id_UERadioCapabilityForPaging_NR_Format	((S1AP_ProtocolIE_ID_t)327)
#define S1AP_ProtocolIE_ID_id_SourceTransportLayerAddress	((S1AP_ProtocolIE_ID_t)328)
#define S1AP_ProtocolIE_ID_id_lastVisitedPSCellList	((S1AP_ProtocolIE_ID_t)329)
#define S1AP_ProtocolIE_ID_id_RACSIndication	((S1AP_ProtocolIE_ID_t)330)
#define S1AP_ProtocolIE_ID_id_PagingCause	((S1AP_ProtocolIE_ID_t)331)
#define S1AP_ProtocolIE_ID_id_SecurityIndication	((S1AP_ProtocolIE_ID_t)332)
#define S1AP_ProtocolIE_ID_id_SecurityResult	((S1AP_ProtocolIE_ID_t)333)
#define S1AP_ProtocolIE_ID_id_E_RABSecurityResultItem	((S1AP_ProtocolIE_ID_t)334)
#define S1AP_ProtocolIE_ID_id_E_RABSecurityResultList	((S1AP_ProtocolIE_ID_t)335)
#define S1AP_ProtocolIE_ID_id_RAT_Restrictions	((S1AP_ProtocolIE_ID_t)336)
#define S1AP_ProtocolIE_ID_id_UEContextReferenceatSourceeNB	((S1AP_ProtocolIE_ID_t)337)
#define S1AP_ProtocolIE_ID_id_LTE_NTN_TAI_Information	((S1AP_ProtocolIE_ID_t)339)
#define S1AP_ProtocolIE_ID_id_SourceNodeTransportLayerAddress	((S1AP_ProtocolIE_ID_t)340)
#define S1AP_ProtocolIE_ID_id_E_RABToBeUpdatedList	((S1AP_ProtocolIE_ID_t)341)
#define S1AP_ProtocolIE_ID_id_E_RABToBeUpdatedItem	((S1AP_ProtocolIE_ID_t)342)
#define S1AP_ProtocolIE_ID_id_SourceSNID	((S1AP_ProtocolIE_ID_t)343)
#define S1AP_ProtocolIE_ID_id_LoggedMDTTrigger	((S1AP_ProtocolIE_ID_t)344)
#define S1AP_ProtocolIE_ID_id_SensorMeasurementConfiguration	((S1AP_ProtocolIE_ID_t)345)
