...
typedef struct S1AP_E_RABToBeSetupItemBearerSUReqIEs	 S1AP_ProtocolIE_SingleContainer_8146P0_t;
typedef struct S1AP_E_RABSetupItemBearerSUResIEs	 S1AP_ProtocolIE_SingleContainer_8146P1_t;
typedef struct S1AP_E_RABToBeModifiedItemBearerModReqIEs	 S1AP_ProtocolIE_SingleContainer_8146P2_t;
typedef struct S1AP_E_RABModifyItemBearerModResIEs	 S1AP_ProtocolIE_SingleContainer_8146P3_t;
typedef struct S1AP_E_RABReleaseItemBearerRelCompIEs	 S1AP_ProtocolIE_SingleContainer_8146P4_t;
typedef struct S1AP_E_RABToBeSetupItemCtxtSUReqIEs	 S1AP_ProtocolIE_SingleContainer_8146P5_t;
typedef struct S1AP_E_RABSetupItemCtxtSUResIEs	 S1AP_ProtocolIE_SingleContainer_8146P6_t;
typedef struct S1AP_TAIItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P7_t;
typedef struct S1AP_UE_associatedLogicalS1_ConnectionItemRes	 S1AP_ProtocolIE_SingleContainer_8146P8_t;
typedef struct S1AP_UE_associatedLogicalS1_ConnectionItemResAck	 S1AP_ProtocolIE_SingleContainer_8146P9_t;
typedef struct S1AP_E_RABModifyItemBearerModConfIEs	 S1AP_ProtocolIE_SingleContainer_8146P10_t;
typedef struct S1AP_Bearers_SubjectToStatusTransfer_ItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P11_t;
typedef struct S1AP_Bearers_SubjectToEarlyStatusTransfer_ItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P12_t;
typedef struct S1AP_DAPSResponseInfoListIEs	 S1AP_ProtocolIE_SingleContainer_8146P13_t;
typedef struct S1AP_E_RABInformationListIEs	 S1AP_ProtocolIE_SingleContainer_8146P14_t;
typedef struct S1AP_E_RABItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P15_t;
typedef struct S1AP_E_RABSecurityResultListIEs	 S1AP_ProtocolIE_SingleContainer_8146P16_t;
typedef struct S1AP_E_RABUsageReportItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P17_t;
typedef struct S1AP_EventTrigger_ExtIEs	 S1AP_ProtocolIE_SingleContainer_8146P18_t;
typedef struct S1AP_MDTMode_ExtensionIE	 S1AP_ProtocolIE_SingleContainer_8146P19_t;
typedef struct S1AP_MeasurementThresholdL1LoggedMDT_ExtIEs	 S1AP_ProtocolIE_SingleContainer_8146P20_t;
typedef struct S1AP_RecommendedCellItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P21_t;
typedef struct S1AP_RecommendedENBItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P22_t;
typedef struct S1AP_SecondaryRATDataUsageReportItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P23_t;
typedef struct S1AP_SensorNameConfig_ExtIEs	 S1AP_ProtocolIE_SingleContainer_8146P24_t;
typedef struct S1AP_SONInformation_ExtensionIE	 S1AP_ProtocolIE_SingleContainer_8146P25_t;
typedef struct S1AP_SourceNodeID_ExtensionIE	 S1AP_ProtocolIE_SingleContainer_8146P26_t;
typedef struct S1AP_E_RABDataForwardingItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P27_t;
typedef struct S1AP_E_RABToBeSetupItemHOReqIEs	 S1AP_ProtocolIE_SingleContainer_8146P28_t;
typedef struct S1AP_E_RABAdmittedItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P29_t;
typedef struct S1AP_E_RABFailedtoSetupItemHOReqAckIEs	 S1AP_ProtocolIE_SingleContainer_8146P30_t;
typedef struct S1AP_E_RABToBeSwitchedDLItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P31_t;
typedef struct S1AP_E_RABToBeSwitchedULItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P32_t;
typedef struct S1AP_E_RABToBeUpdatedItemIEs	 S1AP_ProtocolIE_SingleContainer_8146P33_t;
typedef struct S1AP_E_RABToBeModifiedItemBearerModIndIEs	 S1AP_ProtocolIE_SingleContainer_8146P34_t;
typedef struct S1AP_E_RABNotToBeModifiedItemBearerModIndIEs	 S1AP_ProtocolIE_SingleContainer_8146P35_t;
typedef struct S1AP_E_RABFailedToResumeItemResumeReqIEs	 S1AP_ProtocolIE_SingleContainer_8146P36_t;
typedef struct S1AP_E_RABFailedToResumeItemResumeResIEs	 S1AP_ProtocolIE_SingleContainer_8146P37_t;
