...
#define	_S1AP_RIMInformation_H_
...
/* S1AP_RIMInformation */
typedef OCTET_STRING_t	 S1AP_RIMInformation_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_S1AP_RIMInformation;
