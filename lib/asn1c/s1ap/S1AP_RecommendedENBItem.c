...
asn_TYPE_member_t asn_MBR_S1AP_RecommendedENBItem_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_RecommendedENBItem, mMEPagingTarget),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_RecommendedENBItem, iE_Extensions),
		...
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P118,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_RecommendedENBItem_specs_1 = {
