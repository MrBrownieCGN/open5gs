...
struct S1AP_MMEPagingTarget;
struct S1AP_ProtocolExtensionContainer_8194P118;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_RecommendedENBItem */
typedef struct S1AP_RecommendedENBItem {
	struct S1AP_MMEPagingTarget	*mMEPagingTarget;
...
extern asn_SEQUENCE_specifics_t asn_SPC_S1AP_RecommendedENBItem_specs_1;
extern asn_TYPE_member_t asn_MBR_S1AP_RecommendedENBItem_1[2];
