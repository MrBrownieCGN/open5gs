...
#define	_S1AP_RequestTypeAdditionalInfo_H_
...
/* Dependencies */
typedef enum S1AP_RequestTypeAdditionalInfo {
	S1AP_RequestTypeAdditionalInfo_includePSCell	= 0
	/*
	 * Enumeration is extensible
	 */
} e_S1AP_RequestTypeAdditionalInfo;

/* S1AP_RequestTypeAdditionalInfo */
typedef long	 S1AP_RequestTypeAdditionalInfo_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_S1AP_RequestTypeAdditionalInfo_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_S1AP_RequestTypeAdditionalInfo;
extern const asn_INTEGER_specifics_t asn_SPC_S1AP_RequestTypeAdditionalInfo_specs_1;
...
#endif	/* _S1AP_RequestTypeAdditionalInfo_H_ */
