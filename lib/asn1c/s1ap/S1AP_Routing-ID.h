...
/* S1AP_Routing-ID */
typedef long	 S1AP_Routing_ID_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_S1AP_Routing_ID_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_S1AP_Routing_ID;
