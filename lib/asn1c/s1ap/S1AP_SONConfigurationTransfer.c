...
asn_TYPE_member_t asn_MBR_S1AP_SONConfigurationTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_SONConfigurationTransfer, targeteNB_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_SONConfigurationTransfer, sourceeNB_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_SONConfigurationTransfer, sONInformation),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_SONConfigurationTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P130,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_SONConfigurationTransfer_specs_1 = {
