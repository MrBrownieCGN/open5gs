...
#define	_S1AP_SONInformation_Extension_H_
...
typedef S1AP_ProtocolIE_SingleContainer_8146P25_t	 S1AP_SONInformation_Extension_t;
...
#endif	/* _S1AP_SONInformation_Extension_H_ */
