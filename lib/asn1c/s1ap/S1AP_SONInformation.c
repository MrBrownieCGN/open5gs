...
asn_TYPE_member_t asn_MBR_S1AP_SONInformation_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_SONInformation, choice.sONInformationReply),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_SONInformation, choice.sONInformation_Extension),
