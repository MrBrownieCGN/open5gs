...
static int asn_validate_S1AP_SONInformationRequest_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_SONInformationRequest value = *(e_S1AP_SONInformationRequest*)sptr;
    switch(value) {
    case S1AP_SONInformationRequest_x2TNL_Configuration_Info:
    case S1AP_SONInformationRequest_time_Synchronisation_Info:
    case S1AP_SONInformationRequest_activate_Muting:
    case S1AP_SONInformationRequest_deactivate_Muting:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_S1AP_SONInformationRequest = {
		...
		/sizeof(asn_DEF_S1AP_SONInformationRequest_tags_1[0]), /* 1 */
	{
		...
		asn_validate_S1AP_SONInformationRequest_1
	},
