...
asn_TYPE_member_t asn_MBR_S1AP_SecondaryRATDataUsageReportItem_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_SecondaryRATDataUsageReportItem, e_RABUsageReportList),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_SecondaryRATDataUsageReportItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P124,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
