...
asn_TYPE_member_t asn_MBR_S1AP_ServedGUMMEIsItem_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_ServedGUMMEIsItem, servedPLMNs),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_ServedGUMMEIsItem, servedGroupIDs),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_ServedGUMMEIsItem, servedMMECs),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_ServedGUMMEIsItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P135,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
