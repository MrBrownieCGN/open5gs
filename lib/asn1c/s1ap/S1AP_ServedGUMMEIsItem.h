...
struct S1AP_ServedPLMNs;
struct S1AP_ServedGroupIDs;
struct S1AP_ServedMMECs;
struct S1AP_ProtocolExtensionContainer_8194P135;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_ServedGUMMEIsItem */
typedef struct S1AP_ServedGUMMEIsItem {
	struct S1AP_ServedPLMNs	*servedPLMNs;
	struct S1AP_ServedGroupIDs	*servedGroupIDs;
	struct S1AP_ServedMMECs	*servedMMECs;
