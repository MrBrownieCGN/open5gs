...
static asn_TYPE_member_t asn_MBR_S1AP_SourceeNB_ToTargeteNB_TransparentContainer_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_SourceeNB_ToTargeteNB_TransparentContainer, targetCell_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_SourceeNB_ToTargeteNB_TransparentContainer, uE_HistoryInformation),
