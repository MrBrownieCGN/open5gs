...
struct S1AP_TAListforMDT;
struct S1AP_ProtocolExtensionContainer_8194P145;
struct S1AP_ProtocolExtensionContainer;

/* S1AP_TABasedMDT */
typedef struct S1AP_TABasedMDT {
	struct S1AP_TAListforMDT	*tAListforMDT;
...
extern asn_SEQUENCE_specifics_t asn_SPC_S1AP_TABasedMDT_specs_1;
extern asn_TYPE_member_t asn_MBR_S1AP_TABasedMDT_1[2];
