...
extern asn_SET_OF_specifics_t asn_SPC_S1AP_TAIListForRestart_specs_1;
extern asn_TYPE_member_t asn_MBR_S1AP_TAIListForRestart_1[1];
extern asn_per_constraints_t asn_PER_type_S1AP_TAIListForRestart_constr_1;
