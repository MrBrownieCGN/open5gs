...
asn_TYPE_member_t asn_MBR_S1AP_TargeteNB_ID_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_TargeteNB_ID, global_ENB_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_TargeteNB_ID, selected_TAI),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_TargeteNB_ID, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P149,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
