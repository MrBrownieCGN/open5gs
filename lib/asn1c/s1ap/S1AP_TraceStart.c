...
asn_TYPE_member_t asn_MBR_S1AP_TraceStart_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_TraceStart, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolIE_Container_8143P57,
		0,
		{
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_TraceStart_specs_1 = {
