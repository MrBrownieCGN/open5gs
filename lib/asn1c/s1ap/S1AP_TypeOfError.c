...
static int asn_validate_S1AP_TypeOfError_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_S1AP_TypeOfError value = *(e_S1AP_TypeOfError*)sptr;
    switch(value) {
    case S1AP_TypeOfError_not_understood:
    case S1AP_TypeOfError_missing:
        return 0;
    }
    return -1;
}
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_S1AP_TypeOfError_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
		asn_validate_S1AP_TypeOfError_1
	},
