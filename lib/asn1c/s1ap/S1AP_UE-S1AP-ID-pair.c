...
asn_TYPE_member_t asn_MBR_S1AP_UE_S1AP_ID_pair_1[] = {
...
static const int asn_MAP_S1AP_UE_S1AP_ID_pair_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_S1AP_UE_S1AP_ID_pair_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_S1AP_UE_S1AP_ID_pair_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mME-UE-S1AP-ID */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* eNB-UE-S1AP-ID */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extensions */
};
asn_SEQUENCE_specifics_t asn_SPC_S1AP_UE_S1AP_ID_pair_specs_1 = {
