...
extern asn_SEQUENCE_specifics_t asn_SPC_S1AP_UE_associatedLogicalS1_ConnectionItem_specs_1;
extern asn_TYPE_member_t asn_MBR_S1AP_UE_associatedLogicalS1_ConnectionItem_1[3];
