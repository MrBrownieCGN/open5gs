...
asn_TYPE_member_t asn_MBR_S1AP_UESecurityCapabilities_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_UESecurityCapabilities, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P163,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_UESecurityCapabilities_specs_1 = {
