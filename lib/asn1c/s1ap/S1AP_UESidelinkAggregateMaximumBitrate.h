...
struct S1AP_ProtocolExtensionContainer_8194P164;
...
extern asn_SEQUENCE_specifics_t asn_SPC_S1AP_UESidelinkAggregateMaximumBitrate_specs_1;
extern asn_TYPE_member_t asn_MBR_S1AP_UESidelinkAggregateMaximumBitrate_1[2];
