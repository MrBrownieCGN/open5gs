...
/* S1AP_URI-Address */
typedef VisibleString_t	 S1AP_URI_Address_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_S1AP_URI_Address_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_S1AP_URI_Address;
