...
struct S1AP_HandoverPreparationFailure;
struct S1AP_HandoverFailure;
struct S1AP_PathSwitchRequestFailure;
struct S1AP_InitialContextSetupFailure;
struct S1AP_S1SetupFailure;
struct S1AP_UEContextModificationFailure;
struct S1AP_ENBConfigurationUpdateFailure;
struct S1AP_MMEConfigurationUpdateFailure;
struct S1AP_UEContextResumeFailure;

/* Forward definitions */
typedef struct S1AP_UnsuccessfulOutcome__value {
	S1AP_UnsuccessfulOutcome__value_PR present;
	union S1AP_UnsuccessfulOutcome__S1AP_value_u {
		struct S1AP_HandoverPreparationFailure	*HandoverPreparationFailure;
		struct S1AP_HandoverFailure	*HandoverFailure;
		struct S1AP_PathSwitchRequestFailure	*PathSwitchRequestFailure;
		struct S1AP_InitialContextSetupFailure	*InitialContextSetupFailure;
		struct S1AP_S1SetupFailure	*S1SetupFailure;
		struct S1AP_UEContextModificationFailure	*UEContextModificationFailure;
		struct S1AP_ENBConfigurationUpdateFailure	*ENBConfigurationUpdateFailure;
		struct S1AP_MMEConfigurationUpdateFailure	*MMEConfigurationUpdateFailure;
		struct S1AP_UEContextResumeFailure	*UEContextResumeFailure;
	} choice;
