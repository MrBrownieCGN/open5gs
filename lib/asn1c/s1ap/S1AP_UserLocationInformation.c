...
asn_TYPE_member_t asn_MBR_S1AP_UserLocationInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct S1AP_UserLocationInformation, eutran_cgi),
	...
	{ ATF_POINTER, 0, offsetof(struct S1AP_UserLocationInformation, tai),
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_UserLocationInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_8194P166,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_S1AP_UserLocationInformation_specs_1 = {
